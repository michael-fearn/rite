...
class NewServiceRunbookTests(unittest.TestCase):
    def test_runbook_documents_new_service_authoring_and_deployment(self):
        ...
        expected_phrases = [
            ...
            "service_network",
            "Container Alias",
            "Service Runtime Intent resolves the Service Data Directory facts",
            "Service Runtime Intent resolves the Share-backed Volume facts",
            "Service Runtime Intent owns the Service Secret and Native Service Environment Secret references",
            ...
            "`service-deploy` validates Share-backed Volume subpaths when needed",
